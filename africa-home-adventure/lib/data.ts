...
export const tours: Tour[] = [
    ...
    itinerary: [
      {
        ...
        description:
          "Depart Nairobi and drive to Lake Nakuru. Afternoon game drive around the lake, spotting flamingos, rhinos, and other wildlife.",
      },
      {
        day: 2,
        title: "Lake Nakuru to Lake Naivasha",
        description:
          "Morning game drive in Nakuru. After lunch, transfer to Lake Naivasha for a scenic boat ride spotting hippos and birdlife.",
      },
      {
        day: 3,
        title: "Lake Naivasha to Masai Mara",
        description:
          "Drive south to the Masai Mara. Check in and enjoy an afternoon game drive as the reserve comes alive at golden hour.",
      },
      {
        day: 4,
        title: "Full Day in Masai Mara",
        description:
          "Full day of game drives. Morning and afternoon sessions in different areas of the reserve, maximizing wildlife sightings.",
      },
      {
        day: 5,
        title: "Masai Mara to Nairobi",
        description:
          "Final morning game drive, then return to Nairobi arriving late afternoon.",
      },
    ],
    rating: 4.8,
    reviewCount: 195,
    ...
    itinerary: [
      {
        ...
        description:
          "Drive from Nairobi to Amboseli with stunning views of Kilimanjaro. Afternoon game drive.",
      },
      {
        day: 2,
        title: "Full Day Amboseli",
        description:
          "Full day exploring Amboseli with morning and afternoon game drives. Visit Observation Hill for panoramic views.",
      },
      {
        day: 3,
        title: "Amboseli to Nairobi",
        description:
          "Sunrise game drive for a final wildlife encounter, then return to Nairobi.",
      },
    ],
    rating: 4.7,
    reviewCount: 164,
  ...
  },
  {
    ...
    title: "6-Day Arusha to Ngorongoro Crater, Serengeti & Masai Mara",
    ...
    longDescription:
      "This cross-border safari is the pinnacle of East African wildlife experiences. Starting from Arusha, descend into the Ngorongoro Crater, cross the vast Serengeti plains, and finish in Kenya's legendary Masai Mara. Six days of non-stop wildlife encounters across two countries.",
    highlights: [
    ...
    itinerary: [
      {
        ...
        description:
          "Drive from Arusha to Ngorongoro Conservation Area. Settle at the crater rim lodge with breathtaking views.",
      },
      {
        day: 2,
        title: "Ngorongoro Crater",
        description:
          "Descend into the crater for a full day of wildlife viewing. The crater floor hosts nearly 30,000 animals.",
      },
      {
        day: 3,
        title: "Ngorongoro to Serengeti",
        description:
          "Cross the Serengeti plains, with game viewing en route. Arrive at the central Serengeti for afternoon game drive.",
      },
      {
        day: 4,
        title: "Full Day Serengeti",
        description:
          "Full day exploring the Serengeti, following the migration if in season. Morning and afternoon game drives.",
      },
      {
        day: 5,
        title: "Serengeti to Masai Mara",
        description:
          "Cross the border into Kenya and enter the Masai Mara for a sunset game drive.",
      },
      {
        day: 6,
        title: "Masai Mara to Nairobi",
  ...
  },
  {
    ...
    title:
      "8-Day Lake Nakuru, Masai Mara, Serengeti, Ngorongoro & Lake Manyara",
    shortTitle: "Kenya & Tanzania Combined",
    destination: "Nakuru, Masai Mara, Serengeti, Ngorongoro, Lake Manyara",
    country: "Kenya & Tanzania",
    ...
    itinerary: [
      {
        day: 1,
        title: "Nairobi to Lake Nakuru",
        description: "Drive to Lake Nakuru. Afternoon game drive to see flamingos, rhinos, and leopards.",
      },
      {
        day: 2,
        title: "Lake Nakuru to Masai Mara",
        description: "Morning game drive at Nakuru, then transfer to the legendary Masai Mara.",
      },
      {
        day: 3,
        title: "Full Day Masai Mara",
        description: "Full day of game drives in the Mara, chasing the Big Five.",
      },
      {
        day: 4,
        title: "Masai Mara to Serengeti",
        description: "Cross the border into Tanzania and enter the Serengeti.",
      },
      {
        day: 5,
        title: "Full Day Serengeti",
        description: "Full day in the Serengeti following the Great Migration routes.",
      },
      {
        day: 6,
        title: "Serengeti to Ngorongoro",
        description: "Drive to Ngorongoro Conservation Area. Settle at the crater rim.",
      },
      {
        day: 7,
        title: "Ngorongoro Crater",
        description: "Full day inside the crater, one of Africa's natural wonders.",
      },
      {
        day: 8,
        title: "Ngorongoro to Arusha",
        description: "Drive to Lake Manyara for a brief game drive, then continue to Arusha.",
      },
    ],
    rating: 4.9,
    reviewCount: 156,
...
export const testimonials: Testimonial[] = [
  {
    ...
    avatar: "ST",
    rating: 5,
    text: "An absolutely incredible experience! Our guide James was phenomenal. Seeing the Big Five in their natural habitat was a dream come true. The lodges were comfortable and the food was delicious. Highly recommend Africa Home Adventure!",
    tour: "3-Day Masai Mara Safari",
  },
  {
    id: "2",
    ...
    avatar: "MC",
    rating: 5,
    text: "We booked the 8-day combined Kenya & Tanzania safari for our honeymoon. It exceeded every expectation. The Ngorongoro Crater was breathtaking, and the Serengeti migration was a once-in-a-lifetime sight. Thank you for making our trip so special.",
    tour: "8-Day Kenya & Tanzania Combined",
  },
  {
    id: "3",
    name: "Hans Mueller",
    ...
    avatar: "HM",
    rating: 5,
    text: "Professional organization from start to finish. The 4x4 Land Cruiser was in perfect condition, and our driver knew exactly where to find the animals. The sunset game drives in the Mara were magical. Will definitely return!",
    tour: "5-Day Nakuru & Masai Mara",
  },
  {
    id: "4",
    name: "Emma Rodriguez",
    ...
    avatar: "ER",
    rating: 4,
    text: "A wonderful introduction to African safari. Amboseli with Kilimanjaro in the background was stunning. The elephants came incredibly close to our vehicle. Great value for the price, and the team was so accommodating.",
    tour: "3-Day Amboseli Safari",
  },
  {
    id: "5",
    name: "Pierre Dubois",
    ...
    avatar: "PD",
    rating: 5,
    text: "Exceptional safari experience across two countries. The guides were knowledgeable, the accommodations exceeded expectations, and the wildlife viewing was extraordinary. Africa Home Adventure delivers exactly what they promise.",
    tour: "6-Day Serengeti & Masai Mara",
  },
  {
    id: "6",
    name: "Yuki Tanaka",
    ...
    avatar: "YT",
    rating: 5,
    text: "From the moment we landed, everything was taken care of. The communication before the trip was excellent, the itinerary was perfectly paced, and our guide went above and beyond. Africa truly feels like home with this team.",
    tour: "5-Day Amboseli & Tsavo",
  },
]

export const destinations = [
  { name: "Masai Mara", country: "Kenya" },
  { name: "Amboseli", country: "Kenya" },
  { name: "Lake Nakuru", country: "Kenya" },
  { name: "Lake Naivasha", country: "Kenya" },
  { name: "Tsavo", country: "Kenya" },
  { name: "Serengeti", country: "Tanzania" },
  { name: "Ngorongoro", country: "Tanzania" },
