...
export function AuthModal({ isOpen, onClose, defaultTab = "login" }: AuthModalProps) {
  ...
  {/* Backdrop with blur */}
  <div 
    className="absolute inset-0 bg-base-content/40 backdrop-blur-sm transition-opacity z-9998"
    onClick={onClose}
  />
  
  {/* Modal Container */}
  <div className="relative w-full max-w-md max-h-[90vh] overflow-hidden rounded-2xl border border-base-content/10 bg-base-100 shadow-2xl flex flex-col z-9999">
    
    {/* Close Button */}
    <button
      onClick={onClose}
      className="absolute right-4 top-4 z-102 rounded-full p-2 text-base-content/50 transition-colors hover:bg-base-200 hover:text-base-content"
    ...
    <div className="bg-primary px-6 py-8 text-primary-content shrink-0">
    ...
    {/* Tabs */}
    <div className="flex border-b border-base-content/10 shrink-0">
      <button
